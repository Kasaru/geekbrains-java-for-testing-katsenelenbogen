...
public class BuildAccount {
    ...
    public BuildAccount(String firstName, String lastName, String email, String password, String address, String city, int stateId, String zip, int countryId, String mobilePhone, String addressAlias) {
